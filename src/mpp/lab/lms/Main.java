...
//		member1.addCheckoutRecord(record1);
	...
	private static void testAddNewMember() {
		...
		Role adminRole = new Role("Admin", "can do alot of stuff");
		
		Staff staff1 = new Staff("obama", "12345654", adminRole);
		
		memberService.addMember(12, staff1, "Donald", "Trump", "1000 N Court Street 20A", "Washington DC", "Pensyl", "111-224-2232");
